...
const Booking: React.FC = () => {
  ...
  return (
    <section className="pt-24 pb-16">
      <SEO title="Book a Call | Mohammed Alsaqqaf" description="Schedule a consultation or intro call." canonical="https://www.Mohammed Alsaqqaf.site/booking" url="https://www.Mohammed Alsaqqaf.site/booking" />
